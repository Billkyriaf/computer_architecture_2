...
benchmark=specsjeng
benchmark_files="-c spec_cpu2006/458.sjeng/src/specsjeng -o spec_cpu2006/458.sjeng/data/test.txt -I 100000000"
...
# ~~~~~~~~~~~~~~~~   Test 5 l1 instruction associativity ~~~~~~~~~~~~~~~~
...
l1i_assoc=("--l1i_assoc=2" "--l1i_assoc=4" "--l1i_assoc=8" "--l1i_assoc=1024")  # 1024 is fully associative because there are 1024 blocks
...
index=$((0))
# run the sim for every item in the l2d_size list
for val in ${l1i_assoc[*]}; do 
    ./build/ARM/gem5.opt -d $current_dir/${benchmark}_l1i_assoc_$index configs/example/se.py $cpu_type $cpu_clock --caches --l2cache $l1d_size $l1d_assoc $l1i_size $val $l2_size $l2_assoc $cacheline_size $benchmark_files &
    index=$(($index + 1))
done
