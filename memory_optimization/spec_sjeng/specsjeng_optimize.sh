...
./build/ARM/gem5.opt -d $current_dir/${benchmark}_final configs/example/se.py $cpu_type $cpu_clock --caches --l2cache $l1d_size $l1d_assoc $l1i_size $l1i_assoc $l2_size $l2_assoc $cacheline_size $benchmark_files &
